...
public class ConditionMethod {
     ...
     * @param hint   A hint why the condition failed
     * @param method The actual backing implementation of the condition method
     */
     ...
     *
     * @param context The current executing <code>ExecutionContext</code>
