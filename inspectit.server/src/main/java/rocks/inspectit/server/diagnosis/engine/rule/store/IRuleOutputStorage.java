...
public interface IRuleOutputStorage {
	...
	/**
	 * Stores a collection of <code>RuleOutput</code>s.
	 *
	 * @param outputs
	 ...
	 * @return The latest {@link RuleOutput}s which match one of the <code>requestedTypes</code>.
	 */
	Collection<RuleOutput> findLatestResultsByTagType(Set<String> requestedTypes);

	/**
	 * Delivers a <code>Multimap</code> of all <code>RuleOutput</code>s which did not complete due
	 * to condition errors. The <code>Multimap</code> is indexed by the the tag type this RuleOutput
