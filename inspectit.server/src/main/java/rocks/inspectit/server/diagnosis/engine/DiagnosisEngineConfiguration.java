...
public class DiagnosisEngineConfiguration<I, R> {
    ...
    /**
     * Specifies how long the the engine waits to shutdown properly. <b>Timeout is specified in seconds.</b>
     */
    private int shutdownTimeout = 2;


    /**
     * The amount of threads to process rules withing a Session
     */
     ...
     *
     */
    private Set<Class<?>> ruleClasses = Sets.newHashSet();
    ...
    /**
     * The {@link ISessionCallback}s to be invoked if a session complete. If not provided, it is still possible to provided results from rules directly somehow.
     * <b>It is strongly recommended to use callback mechanism instead of work around in rule implementations</b>
     */
    private List<ISessionCallback<R>> callbacks = Lists.newArrayList();
     ...
     *
     * @param numSessionWorkers New value for {@link #numRuleWorkers}
     ...
     *
     * @param executorService New value for {@link #executorService}
     * @return DiagnosisEngineConfiguration itself
     */
     ...
     *
     * @param ruleClasses New values for {@link #ruleClasses}
     * @return DiagnosisEngineConfiguration itself
     */
     ...
     *
     * @param ruleClass A new value for {@link #ruleClasses}
     * @return DiagnosisEngineConfiguration itself
     */
     ...
     *
     * @param resultCollector New value for {@link #resultCollector}
     * @return DiagnosisEngineConfiguration itself
     */
     ...
     *
     * @param callback A new callback for {@link #callbacks}
     * @return DiagnosisEngineConfiguration itself
     */
     ...
     *
     * @param sessionCallbacks New entries for {@link #callbacks}
     * @return DiagnosisEngineConfiguration itself
     */
