 ...
 *
 * @param <I> The input type to be analyzed.
...
public interface IDiagnosisEngine<I> {
     ...
     *
     * @param input Any kind of object to be analyzed.
     */
     ...
     *
     * @param input     Any kind of object to be analyzed.
     * @param variables Variables to be available while processing the input.
     */
     ...
     *
     * @param awaitShutdown The flat to indicate if method will block until shutdown is complete.
     * @throws Exception
     */
