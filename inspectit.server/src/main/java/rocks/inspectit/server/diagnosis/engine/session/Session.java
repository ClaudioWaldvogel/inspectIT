...
/**
 * The Session is the core class of the {@link IDiagnosisEngine}. It executes all rules, stores interim results, and prepares the final results by utilizing the {@link ISessionResultCollector}. To
 * ensure a proper execution it defines a explicit life cycle. To ensure a compliance with the life cycle the current state of session is held in a {@link State} object. Additional runtime
 ...
 * </pre>
 * <p>
 * In order to facilitate compliance with the life cycle it is strongly recommended to use the provided {@link SessionPool} in combination with {@link ExecutorService}.
 * <p>
 * <pre>
 * {@code
...
public class Session<I, R> implements Callable<R> {
     ...
     *
     * @param <I> The input type of the Session
     * @param <R> The result type this Session produces
     */
    public static class Builder<I, R> {
         ...
         *
         * @param numRuleWorkers New value for {@link #numRuleWorkers}
         ...
         *
         * @param shutDownTimeout New value for {@link #shutDownTimeout}
         * @return The Builder itself
         */
         ...
         *
         * @param ruleDefinitions New value for {@link #ruleDefinitions}
         * @return The Builder itself
         */
         ...
         *
         * @param storageClass New value for {@link #storageClass}
         * @return The Builder itself
         */
         ...
         *
         * @param sessionResultCollector New value for {@link #sessionResultCollector}
         * @return The Builder itself
         */
     ...
     *
     * @param input     The input to be processed.
     * @param variables The SessionVariables to be used
     * @return The Session itself
     ...
     *
     * @param definition The <code>RuleDefinition</code> to be executed.
    ...
    private class RuleExecution implements Callable<Collection<RuleOutput>> {
         ...
         * Default Constructor
         *
         * @param definition {@link RuleDefinition} to be executed}.
         */
