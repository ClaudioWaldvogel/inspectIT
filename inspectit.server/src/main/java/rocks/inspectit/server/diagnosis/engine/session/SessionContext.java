 ...
 * not viable without a <code>Session</code>. <br>
 * <code>SessionContext</code>s implement the same life cycle as <code>Sessions</code>:
...
public class SessionContext<I> {
	 ...
	 * <code>RuleDefinition</code>, this definition is evicted from the set. Thus it is easily
	 * possible to determine when a <code>Session</code> executed all possible
	 * <code>RuleDefinition</code>s.
	 *
	 * @see RuleDefinition
	 * @see Session
	 */
